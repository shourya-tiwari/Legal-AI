...
_ADDED_COLUMNS: list[tuple[str, str, str]] = [
    ...
    ("documents", "original_sha256", "VARCHAR(64)"),
    ("documents", "original_size", "INTEGER"),
    ...
    ("case_analyses", "negotiation_suggestions", "JSON"),
    ("organizations", "feature_flags", "JSON"),
    ("organizations", "webhook_url", "VARCHAR(2048)"),
    ("organizations", "negotiation_preferences", "JSON"),
]
