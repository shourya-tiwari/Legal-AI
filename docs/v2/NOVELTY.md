...
4. **These are research proposals, not implemented systems.** Each would require a research/validation phase (prototyping, benchmarking against baselines, and — for any patent consideration — formal prior-art search) before being treated as a product feature, per `ROADMAP.md` Phase 4.
