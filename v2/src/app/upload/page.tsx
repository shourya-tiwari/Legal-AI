  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      <main className="mx-auto flex w-full max-w-2xl flex-1 flex-col items-center px-6 py-16">
        ...
        <h1 className="mt-4 text-center text-3xl font-semibold tracking-tight text-white">
        ...
        <div
          ...
          className={`mt-8 flex w-full cursor-pointer flex-col items-center gap-3 rounded-2xl border-2 border-dashed px-8 py-16 text-center shadow-sm backdrop-blur transition-all ${
            isDragOver
        ...
        >
          <span className="flex h-14 w-14 items-center justify-center rounded-full bg-indigo-500/15 text-2xl" aria-hidden="true">
            📄
          </span>
          {file ? (
            <div>
        ...
        <button
          ...
          className="mt-6 w-full rounded-full bg-gradient-to-r from-indigo-500 to-blue-500 px-4 py-3 text-sm font-semibold text-white shadow-md shadow-indigo-950 transition-transform hover:scale-[1.01] disabled:cursor-not-allowed disabled:from-zinc-700 disabled:to-zinc-700 disabled:text-zinc-400 disabled:shadow-none"
        >
